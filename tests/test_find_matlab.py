...
class TestFindMatlab:
    ...
    def test_query_matlab_version(self):
        ...
        version = query_matlab_version(matlab_exe)
    ...
    def test_find_matlab_version(self):
        ...
        found_matlab = find_matlab_version(expected_version, install_list)
    ...
    def test_find_matlab_release(self):
        ...
        found_matlab = find_matlab_release(release_name, install_list)
    ...
    def test_find_matlab_with_path(self):
        ...
        found_matlab, return_code = find_matlab(potential_matlab_path=matlab_exe)
        assert found_matlab is not None
        assert return_code == ReturnCode.OK
    ...
    def test_find_matlab_with_fake_path(self):
        ...
        found_matlab, return_code = find_matlab(potential_matlab_path=fake_matlab)
    ...
    def test_fake_version_find_matlab_version(self):
        ...
        fake_version = "0.00"
        found_matlab = find_matlab_version(fake_version, install_list)
    ...
    def test_fake_release_find_matlab_release(self):
        ...
        fake_release = "R0000a"
        found_matlab = find_matlab_release(fake_release, install_list)
